...
const CACHE = "bartlopen-julia-interval-uitleg-1-p2-u2";
const ASSETS = ["./","./index.html","./styles.css?v=3-c3-p2-u2","./app.js?v=interval-uitleg-1-p2-u2","./coach.jpg","./coach-logo.png","./bartlopen-runcoach.png","./icon-192.png","./icon-512.png","./apple-touch-icon.png","./manifest.json"];
