...
const CACHE = "bartlopen-julia-interval-uitleg-1";
const ASSETS = ["./","./index.html","./styles.css?v=3-c3","./app.js?v=interval-uitleg-1","./coach.jpg","./coach-logo.png","./bartlopen-runcoach.png","./icon-192.png","./icon-512.png","./apple-touch-icon.png","./manifest.json"];
