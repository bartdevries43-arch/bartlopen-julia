...
const CACHE = "bartlopen-julia-interval-uitleg-1-p2-u2-m2-bugfix-schuifmelding";
const ASSETS = ["./","./index.html","./styles.css?v=3-c3-p2-u2-m2-bugfix-schuifmelding","./app.js?v=3-c3-p2-u2-m2-bugfix-schuifmelding","./coach.jpg","./coach-logo.png","./bartlopen-runcoach.png","./icon-192.png","./icon-512.png","./apple-touch-icon.png","./manifest.json"];
